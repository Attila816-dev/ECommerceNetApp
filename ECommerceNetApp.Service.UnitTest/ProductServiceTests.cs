...
// _mockProductRepository.Setup(repo => repo.GetAllAsync(CancellationToken.None))
...
// _mockProductRepository.Setup(repo => repo.GetProductsByCategoryIdAsync(1, CancellationToken.None))
//                .ReturnsAsync(products);
...
// _mockProductRepository.Setup(repo => repo.AddAsync(It.IsAny<Product>(), CancellationToken.None))
//                .ReturnsAsync(product);
...
// _mockProductRepository.Verify(repo => repo.AddAsync(It.IsAny<Product>(), CancellationToken.None), Times.Once);
//        }
...
// _mockProductRepository.Setup(repo => repo.GetByIdAsync(999, CancellationToken.None))
...
// // Assert
//            _mockProductRepository.Verify(repo => repo.DeleteAsync(1, CancellationToken.None), Times.Once);
//        }
