...
- **ECommerceNetApp.Service**  
 Implements application services, commands, and validators using FluentValidation.  
...
- **ECommerceNetApp.Service**  
Implements application services, commands, and validators using custom Mediator pattern and FluentValidation.  

- **ECommerceNetApp.Persistence**  
Handles database interactions and data persistence using Entity Framework Core and LiteDb NoSql database.  

- **ECommerceNetApp.Api**  
Exposes RESTful APIs with versioning, Swagger documentation, health checks, and error handling middleware.  
...
Unit tests for the service layer using xUnit, Moq, Moq.EntityFrameworkCore, and Shouldly.  
...
Integration tests for the API layer using Microsoft.AspNetCore.Mvc.Testing, Entity Framework Core In-Memory provider, and LiteDb.  
...
- **Testing**: Comprehensive unit and integration tests using xUnit, Moq, Moq.EntityFrameworkCore, and Shouldly.  
