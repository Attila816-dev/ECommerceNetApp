...
{
    public class CategoryDetailType : ObjectType<CategoryDetailDto>
    {
        protected override void Configure(IObjectTypeDescriptor<CategoryDetailDto> descriptor)
        {
            ArgumentNullException.ThrowIfNull(descriptor);
            descriptor.Description("Represents detailed information about a category");
            ...
            descriptor.Field("products")
                ...
                .Resolve(async context =>
                {
                    ...
                    var categoryId = context.Parent<CategoryDetailDto>().Id;
